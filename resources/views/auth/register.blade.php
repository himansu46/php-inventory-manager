        ...
        <div class="col-xl-8 col-lg-9">
            ...
            <div class="card my-5">
                ...
                <div class="card-body p-5">
                    <div class="text-center small text-muted mb-4"><h2><u>Inventory Management System</u></h2></div>
                
                    <div class="text-center small text-muted mb-4"><h3>Create An Account</h3></div>
                    <!-- BEGIN: Login Form -->
